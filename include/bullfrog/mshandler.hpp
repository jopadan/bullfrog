...
class MouseStateHandler {
 public:
    ...
    bool SetMousePosition(s32 x, s32 y);
    bool SetPosition(s32 x, s32 y);
    const struct TbSprite *GetPointer(void);
    bool SetMousePointerAndOffset(const struct TbSprite *mouseSprite, s32 x, s32 y);
    bool SetMousePointer(const struct TbSprite *mouseSprite);
    bool SetPointerOffset(s32 x, s32 y);
    struct TbPoint *GetPointerOffset(void);
    bool SetMouseWindow(s32 x, s32 y, s32 width, s32 height);
