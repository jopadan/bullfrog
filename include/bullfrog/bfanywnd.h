...
TbResult LbTextSetJustifyWindow(s32 x, s32 y, u32 width);
TbResult LbTextSetClipWindow(s32 x, s32 y, u32 width, u32 height);
TbResult LbTextSetWindow(s32 x, s32 y, u32 width, u32 height);
