...
static TbResult LbI_ScreenDrawHLineDirect(s32 X1, s32 Y1, s32 X2, s32 Y2)
{
    ubyte *ptr;
    ubyte *ptrEnd;
    s32 xBeg, xEnd;
...
static TbResult LbI_ScreenDrawVLineDirect(s32 X1, s32 Y1, s32 X2, s32 Y2)
{
    ubyte *ptr;
    ubyte *ptrEnd;
    s32 yBeg, yEnd;
    s32 height, shiftX, shiftY;
    s32 delta;
